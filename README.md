...
![AI Doc Intel UI](c-projects/AI-DOC-INTEL/ai-doc-intel/assets/ui.png)

### Local setup (step-by-step)

Application code lives in **`c-projects/AI-DOC-INTEL/ai-doc-intel`**. From your clone root, go there once; paths below (`backend`, `frontend`) are relative to that folder:

```bash
cd c-projects/AI-DOC-INTEL/ai-doc-intel
```
...
- Supabase → **SQL Editor**
- Run **`backend/supabase_setup.sql`** (from the `ai-doc-intel` folder path above)
...
Run (after `cd` into `ai-doc-intel`):
